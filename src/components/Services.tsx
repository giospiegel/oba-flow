...
const services = [
  {
    ...
    description: "Automatically extract and process data from image documents, classifies invoices, receipts, and other unsupported documents with AI-powered accuracy.",
